...
public class SlidingSwitcherView extends RelativeLayout implements OnTouchListener{
    ...
    /*回滚速度*/
    public static final int scrollToFirstSpeed=23333333;
    /** 
     * SlidingSwitcherView的宽度。 
     */  
    private int switcherViewWidth; 
    /** 
     * SlidingSwitcherView的高度。 
     */  
     ...
     */  
	 public void scrollToNext() {  
	    ...
	    private void initializeItems() {  
	        ...
	        switcherViewHeight=switcherViewWidth/2;
	        ...
	        for (int i = 0; i < itemsCount; i++) {  
	            ...
	            params.height=switcherViewHeight;
	    ...
	    public void scrollToFirstItem() {  
	        new ScrollToFirstItemTask().execute(scrollToFirstSpeed);  
	    }  
	    /** 
	     * 用于在定时器当中操作UI界面。 
	     */  
